...
const Contact = () => {
  return (
    ...
    <div className="flex justify-center items-center">
        ...
        <textarea name="message" type="message" rows="6" placeholder='Enter your Message' className="p-2 bg-transparent border-2 rounded-md text-white focus:outline-none"></textarea>
